        ...
        Rectangle {
            ...
            MouseArea{
                ...
                onPositionChanged:  (mouseX, mouseY) => {
                                        ...
                                        if (diffX > 0 && diffY > 0) {
                                            clockHandRoot.rotation = 90 - Math.abs (deg);
                                        }
                                        else if (diffX > 0 && diffY < 0) {
                                            clockHandRoot.rotation = 90 + Math.abs (deg);
                                        }
                                        else if (diffX < 0 && diffY > 0) {
                                            clockHandRoot.rotation = 270 + Math.abs (deg);
                                        }
                                        else if (diffX < 0 && diffY < 0) {
                                            clockHandRoot.rotation = 270 - Math.abs (deg);
                                        }
